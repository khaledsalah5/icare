...
//     chartData.add(LiveData(time += 0.3, y=ECGValue1+1));
...
// class bedScreen extends StatefulWidget {
//   @override
//   _LiveChartScreenState createState() => _LiveChartScreenState();
// }

// class _LiveChartScreenState extends State<bedScreen> {
...
//     timer = Timer.periodic(Duration(milliseconds: 300), (Timer t) => fetchData()); // Fetch data every 5 seconds
//   }
...
//   //   final response = await http.get(Uri.parse('http://10.23.246.243/api/DisplaySensorValue?sensor=BT'));

//   //   if (response.statusCode == 200) {

//   //     final dynamic jsonData = json.decode(response.body);
//   //     final double value = double.parse(jsonData['data']);
